// Optimal posting times and heatmap generator for YouTube, Instagram, Facebook, Twitter/X, and Google Business Profile
export const platformTimingData = {
  youtube: {
    name: "YouTube & Shorts",
...
export function getOptimalSchedule(platform, timezone = "Asia/Kolkata") {
